  ...
  <div class="w-[50%] mx-auto py-10">
    ...
    <div class="bg-white p-6 rounded-xl shadow mb-8">
      ...
      <textarea
        ...
        name="content" required rows="4" placeholder="What's on your mind?"></textarea>
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white p-5 rounded-xl shadow">
        <p class="text-gray-700 text-2xl">Just finished building a Tailwind CSS app and it looks amazing! 🚀</p>
        <div class="text-sm text-gray-400 mt-2">Posted by {{ $post->user->name}} - {{ $post->created_at->diffForHumans() }} </div>
